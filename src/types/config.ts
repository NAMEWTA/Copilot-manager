...
export interface ProxyConfig {
    ...
    zai?: ZaiConfig;
    copilot?: CopilotConfig;  // ⚠️ 非官方 API，使用风险自负
...
export type CopilotDispatchMode = 'off' | 'exclusive' | 'pooled' | 'fallback';

export interface CopilotConfig {
    enabled: boolean;
    github_token: string;  // GitHub Personal Access Token 或 OAuth Token
    dispatch_mode: CopilotDispatchMode;
